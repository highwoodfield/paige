...
let s:alt_fg_text             = [ '231', '245',          '', '#f9f9f9', '#8a8a8a',          '' ]
let s:alt_fg_text_none        = [ '231', '245',      'none', '#f9f9f9', '#8a8a8a',      'none' ]
...
let s:alt_bg_text_none        = [ '254', '232',      'none', '#eaeaea', '#000000',      'none' ]
...
let s:alt_purple_bg_text_none = [ '139', '232',      'none', '#c6aaff', '#000000',      'none' ]

let s:red_fg_text             = [ '231', '196',          '', '#f9f9f9', '#ff0000',          '' ]
let s:green_fg_text           = [ '231',  '34',          '', '#f9f9f9', '#00af00',          '' ]
let s:blue_fg_text            = [ '231',  '21',          '', '#f9f9f9', '#3acaff',          '' ]
let s:blue_fg_text_underline  = [ '231',  '21', 'underline', '#f9f9f9', '#3acaff', 'underline' ]

let s:menu_select             = [ '70 ', '231',      'bold', '#5faf00', '#f9f9f9',          '' ]
let s:menu_no_select          = [ '240', '231',          '', '#585858', '#f9f9f9',          '' ]
